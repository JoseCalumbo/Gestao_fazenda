...
<head>
    ...
    ═══════════════════════════════════════════ */
        ...
        /* ═══════════════════════════════════════════
       MODAL — FINALIZAR VENDA (layout duas colunas)
    ═══════════════════════════════════════════ */


        /* Altere esta parte no seu CSS */
        .modal-coop .modal-dialog {
            max-width: 900px;
            /* Altere aqui para o tamanho que desejar */
            width: 100%;
        }
        ...
        /* ═══════════════════════════════════════════
       MODAL — RESUMO DA VENDA (sem botão fechar)
    ═══════════════════════════════════════════ */
...
══════════════════════════════════════ -->
    ...
    <!-- ══════════════════════════════════════
     MODAL — RESUMO DA VENDA (sem botão fechar)
══════════════════════════════════════ -->
    <div class="modal fade modal-coop modal-resumo" id="modalResumoVenda" tabindex="-1" aria-hidden="true"
        data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <!-- Botão fechar removido - só pode fechar pelo botão abaixo -->
                </div>
    ...
    <script>
        ...
        ══════════════════════════════════════ */
        let produtos = [
            { id: 1, nome: 'Milho (saco 50kg)', categoria: 'Grao', stock: 45, preco: 12000 },
            { id: 2, nome: 'Feijão (saco 25kg)', categoria: 'Grao', stock: 30, preco: 18500 },
            { id: 3, nome: 'Mandioca (caixa 20kg)', categoria: 'Tuberculo', stock: 60, preco: 8500 },
            { id: 4, nome: 'Batata-doce (caixa 15kg)', categoria: 'Tuberculo', stock: 40, preco: 7200 },
            { id: 5, nome: 'Tomate (caixa 10kg)', categoria: 'Legume', stock: 25, preco: 4500 },
            { id: 6, nome: 'Cebola (saco 25kg)', categoria: 'Legume', stock: 35, preco: 6800 },
            { id: 7, nome: 'Banana (caixa 20kg)', categoria: 'Fruta', stock: 20, preco: 9200 },
            { id: 8, nome: 'Laranja (caixa 25kg)', categoria: 'Fruta', stock: 15, preco: 10500 },
            { id: 9, nome: 'Arroz (saco 50kg)', categoria: 'Grao', stock: 50, preco: 15000 },
            { id: 10, nome: 'Alface (maço)', categoria: 'Legume', stock: 100, preco: 500 },
        ];
        ...
        document.getElementById('btnConfirmarVenda').addEventListener('click', function () {
            ...
            setTimeout(() => {
                ...
                // Preparar resumo
                document.getElementById('resumoNumero').textContent = '#' + numVenda;
                document.getElementById('resumoNumeroTop').textContent = '#' + numVenda;
                ...
                document.getElementById('resumoPagamento').textContent = pagamento.charAt(0).toUpperCase() + pagamento.slice(1);
                document.getElementById('resumoStatus').textContent = status === 'pago' ? 'Pago' : 'Pendente';
