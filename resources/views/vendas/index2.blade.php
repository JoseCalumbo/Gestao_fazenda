...
<head>
  ...
  <style>
    ...
    *, *::before, *::after {
    ...
    /* ═══════════════════════════════════════════
       MODAL — FINALIZAR VENDA (duas partes)
    ═══════════════════════════════════════════ */
    ...
    /* Parte superior: dados do cliente e pagamento */
    .modal-top-section {
    ...
    /* Parte inferior: resumo da venda com scroll */
    .modal-bottom-section {
      flex: 1;
      overflow-y: auto;
      padding: 16px 24px 20px 24px;
    }
    .modal-bottom-section::-webkit-scrollbar { width: 4px; }
    .modal-bottom-section::-webkit-scrollbar-thumb { background: rgba(0,0,0,.12); border-radius: 4px; }
    ...
    .modal-form-card:last-child { margin-bottom: 0; }
    ...
    /* ═══════════════════════════════════════════
       MODAL — RESUMO DA VENDA (segundo modal)
    ═══════════════════════════════════════════ */
    .modal-resumo .modal-content { max-width: 600px; }
    .modal-resumo .modal-body { background: #fff; }
    ...
    body.dark-mode .modal-top-section { background: #1e2a20; }
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <!-- PARTE SUPERIOR: Dados do Cliente e Pagamento (fixa) -->
