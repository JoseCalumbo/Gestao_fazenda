                ...
                <tbody id="produtoTableBody">
                  @forelse($produtos as $produto)
                    <tr id="produto-row-{{ $produto->id }}" data-nome="{{ $produto->nome }}"
                      data-preco="{{ $produto->preco_venda }}" data-stock="{{ $produto->quantidade }}">
                      <td>
                      ...
                      <td><strong>{{ number_format($produto->preco_venda, 0, ',', '.') }}</strong></td>
                      ...
                      <td style="text-align:center;">
                        <button class="btn btn-sm btn-success btn-add-cart" data-id="{{ $produto->id }}"
                          data-nome="{{ $produto->nome }}" data-preco="{{ $produto->preco_venda }}"
