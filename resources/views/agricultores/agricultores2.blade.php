        ...
        <div class="content-inner">
            ...
            <div class="page-header anim">
                ...
                <div style="display:flex;gap:10px;flex-wrap:wrap;">
                    ...
                    <button class="btn-green" id="btnNovoAgricultor" data-bs-toggle="modal"
                        data-bs-target="#modalAgricultor">
            ...
            <div class="table-card anim anim-d2">
                ...
                <div class="table-card-header">
                    <div style="display:flex;align-items:center;gap:12px;">
                        <h5><i class="bi bi-person-badge-fill me-2" style="color:var(--primary);"></i>Lista de
                            Agricultores</h5>
                    </div>
                    <div style="display:flex;gap:8px;align-items:center;">
                        {{-- <span style="font-size:12.5px;color:var(--text-light);" id="tableCountTop">4
                            registos</span> --}}
                    </div>
                </div>
                ...
                <form action="{{ route('agricultores.index') }}" method="GET" class="search-filter-bar" id="filterForm">
                    ...
                    <select class="filter-select" name="cooperativa_id" id="filterCooperativa"
                    ...
                    {{-- <select class="filter-select" name="tipo_membro" id="filterCargo"
                        onchange="this.form.submit()"> --}}
                        <select class="filter-select" id="filterCargo" name="cargo" class="form-select"
                            onchange="document.getElementById('filterForm').submit();">
                            <option value="">Todos os cargos</option>
                            <option value="Nenhum" {{ request('cargo') == 'Nenhum' ? 'selected' : '' }}>Nenhum - Apenas
                                Membro</option>
                            <option value="Presidente" {{ request('cargo') == 'Presidente' ? 'selected' : '' }}>Presidente
                            </option>
                            <option value="Vice-Presidente" {{ request('cargo') == 'Vice-Presidente' ? 'selected' : '' }}>
                                Vice-Presidente</option>
                            <option value="Secretário" {{ request('cargo') == 'Secretário' ? 'selected' : '' }}>Secretário
                            </option>
                            <option value="Tesoureiro" {{ request('cargo') == 'Tesoureiro' ? 'selected' : '' }}>Tesoureiro
                            </option>
                            <option value="Técnico" {{ request('cargo') == 'Técnico' ? 'selected' : '' }}>Técnico</option>
                            <option value="Dirigente" {{ request('cargo') == 'Dirigente' ? 'selected' : '' }}>Dirigente
                            </option>
                        </select>
            </div>
            </select>
                                ...
                                <td style="text-align:center;">
                                    <div style="display:flex;gap:6px;justify-content:center;">
                                        ...
                                        <button class="action-btn edit btn-editar-ag" title="Editar"
                                            ...
                                            data-nome_completo="{{ $agricultor->nome_completo }}"
                                            data-sexo="{{ $agricultor->sexo ?? '' }}"
                                            data-nascimento="{{ $agricultor->data_nascimento ?? '' }}"
                                            data-bilhete="{{ $agricultor->bilhete ?? '' }}"
                                            ...
                                            data-cooperativa_id="{{ $cooperativaId }}"
                                            data-cargo_cooperativa="{{ $cargoCooperativa }}"
                                        ...
                                        <button class="action-btn delete btn-eliminar-ag" title="Apagar"
                                            data-id="{{ $agricultor->id }}" data-nome="{{ $agricultor->nome_completo }}">
            ...
            <div class="table-footer">
                ...
                <div class="pagination-btns">
                    ...
                    @else
                        <a href="{{ $agricultores->previousPageUrl() }}" class="page-btn"><i
                    ...
                    @if ($agricultores->hasMorePages())
                        <a href="{{ $agricultores->nextPageUrl() }}" class="page-btn"><i
                            ...
                            <div class="modal-form-card">
                                ...
                                <div style="display:flex;align-items:center;gap:22px;">
                                    <div class="foto-upload-zone"
                                        onclick="document.getElementById('agFotoInput').click()" id="agFotoZone">
                                        <i class="bi bi-person-circle"></i>
                                        <span>Carregar foto</span>
                                    </div>
                                    <input type="file" id="agFotoInput" name="foto" accept="image/*"
                                        style="display:none;">
                                    <div>
                                        <div
                                            style="font-size:13px;font-weight:600;color:var(--text-dark);margin-bottom:4px;">
                                            Foto do
                                            agricultor (opcional)</div>
                                        <div style="font-size:12px;color:var(--text-light);margin-bottom:10px;">JPG ou
                                            PNG · Máx. 2 MB ·
                            ...
                            <div class="modal-form-card">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <input class="cfg-input" type="date" id="agNascimento" name="data_nascimento"
                                            required>
                                    </div>
                                    <div class="col-12 col-md-4">
                                        <label class="cfg-label" for="agBI">Bilhete de Identidade *</label>
                                        <input class="cfg-input" type="text" id="agBI" name="bi"
                                            placeholder="Ex: 004512378LA041" required>
                                    </div>
                                    <div class="col-12 col-md-4">
                                        <label class="cfg-label" for="agNIF">NIF <span class="cfg-helper"
                                                style="display:inline;">(opcional)</span></label>
                                        <input class="cfg-input" type="text" id="agNIF" name="nif"
                                            placeholder="Ex: 004512378">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="modal-form-card">
                                ...
                                <div class="row g-3">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input class="cfg-input" type="tel" id="agTelefone" name="telefone"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input class="cfg-input" type="email" id="agEmail" name="email"
                                            placeholder="agricultor@email.ao">
                                    </div>
                                </div>
                            </div>
                            <div class="modal-form-card">
                            ...
                            <div class="modal-form-card">
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <div class="cfg-helper">Define se o agricultor está em actividade no sistema
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div
                        ...
                        <div style="display:flex;gap:10px;">
                            ...
                            <button type="button" class="btn-green" id="btnGuardarAg">
                                <i class="bi bi-check2-circle"></i> <span id="btnGuardarAgLabel">Registar
                                    Agricultor</span>
                            </button>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                <div class="modal-header" style="background:linear-gradient(135deg, #7f0000, #C62828);">
                    <div style="display:flex;align-items:center;gap:14px;flex:1;">
                        ...
                        <div>
                            ...
                            <div style="font-size:12px;color:rgba(255,255,255,.65);margin-top:2px;">Esta acção é
                                irreversível</div>
                        </div>
                    </div>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fechar"></button>
                ...
                <div class="modal-body" style="background:#fff;padding:28px;">
                    ...
                    <div
                        ...
                        <div style="font-size:12px;color:var(--text-light);margin-top:3px;">Todos os dados associados
                            serão
