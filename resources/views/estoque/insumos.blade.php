...
<main id="main">
  <div class="content-inner">
    ...
    <!-- Tabs -->
    <ul class="nav nav-tabs-custom anim anim-d2" id="estoqueTabs" role="tablist">
      <li class="nav-item" role="presentation">
        <button class="nav-link active" id="tab-disponiveis" data-bs-toggle="tab" data-bs-target="#disponiveis" type="button" role="tab">
          <i class="bi bi-box-seam-fill"></i> Insumos Disponíveis
        </button>
      </li>
      <li class="nav-item" role="presentation">
        <button class="nav-link" id="tab-historico" data-bs-toggle="tab" data-bs-target="#historico" type="button" role="tab">
    ...
    <!-- Tab Panels -->
    <div class="tab-content anim anim-d3">

      <!-- ════════════════════════
           TAB 1 — INSUMOS DISPONÍVEIS
      ════════════════════════ -->
      <div class="tab-pane active" id="disponiveis" role="tabpanel">
...
function renderInsumos() {
  ...
  // Atualizar cards
  document.getElementById('totalEstoque').textContent = insumosData.reduce((acc, i) => acc + i.stock_atual, 0);
