                ...
                <tr id="insumo-row-{{ $insumo->id }}" data-tipo="{{ strtolower($insumo->tipo) }}"
                  ...
                  <td style="text-align:center;">
                    <div style="display:flex;gap:6px;justify-content:center;">
                      ...
                      <button class="action-btn view btn-editar-insumo btn-ver-talhao" title="Ver detalhes" id="modalVerTalhao"
                       data-id="{{ $insumo->id }}"
                        data-nome="{{ $insumo->nome }}" data-tipo="{{ $insumo->tipo }}"
                        data-quantidade="{{ $insumo->quantidade }}" data-unidade="{{ $insumo->unidade }}"
                        data-preco="{{ $insumo->preco_unitario }}" data-entrada="{{ $insumo->data_entrada }}"
