    ...
    <div class="content-inner">
      ...
      <div class="page-header anim">
        <div>
          ...
          <p>Visão geral da Cooperativa Viana — Safra 2025/26</p>
        </div>
      </div>
        ...
        <div class="col-6 col-xl-3">
          <div class="stat-card">
            ...
            <div class="stat-info">
              ...
              <div class="s-value">{{ $producaoTotal ?? 0 }}</div>
              <span class="stat-badge up"><i class="bi bi-arrow-up"></i> 7.7%</span>
            </div>
          </div>
        </div>
        <div class="col-6 col-xl-3">
            ...
            <div class="table-responsive">
              <table class="table mb-0">
                ...
                <tbody>
                  ...
                  @empty
                    <tr>
                      <td colspan="4" class="text-center">Nenhum movimento recente.</td>
                    </tr>
                  @endforelse
                </tbody>
              </table>
            ...
            <div class="col-12">
              <div class="chart-card">
                ...
                <div class="row g-2">
                  ...
                  <div class="col-3">
                    <a href="{{route('cooperativas')}}" class="quick-card">
                      <i class="bi bi-building"></i>
                      <span>Cooperativas</span>
                    </a>
                  </div>
                  <div class="col-3">
                    <a href="{{route('vendas')}}" class="quick-card">
                      <i class="bi bi-cart-fill"></i>
                      <span>Vendas</span>
                    </a>
                  </div>
