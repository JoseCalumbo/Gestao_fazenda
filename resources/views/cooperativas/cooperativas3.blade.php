                ...
                <tr data-estado="activa" data-provincia="Luanda" data-safra="activa">
                  ...
                  <td style="text-align:center;">
                    <div style="display:flex;gap:6px;justify-content:center;">
                      ...
                      <a href="{{ route('cooperativas.pdfItem', $cooperador->id) }}" class="action-btn print"
                        title="Imprimir ficha" target="_blank">
...
══════════════════════════════════════ -->
  ...
  <script>
      ...
      fetch(`/cooperativas/${id}/edit`, {
        ...
        .then(res => {
          if (res.success) {
            ...
            document.getElementById('estadoCoop').value = d.estado;
    ...
    document.getElementById('btnSalvarCoop').addEventListener('click', () => {
      ...
      if (!nome || !nif || !municipio || !provincia || !telefone) {
