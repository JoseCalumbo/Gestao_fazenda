...
══════════════════════════════════════ -->
  ...
  `).join('');
    ...
    <a class="page-link" href="#" onclick="carregarAgricultores(${data.current_page - 1});return false;">«</a></li>`;
      for (let i = 1; i <= data.last_page; i++) {
        html += `<li class="page-item ${i === data.current_page ? 'active' : ''}">
      <a class="page-link" href="#" onclick="carregarAgricultores(${i});return false;">${i}</a></li>`;
      }
