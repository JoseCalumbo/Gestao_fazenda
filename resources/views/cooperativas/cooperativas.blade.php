              ...
              @foreach($cooperativas as $cooperador)
                <tr data-estado="activa" data-provincia="Luanda" data-safra="activa">
                  ...
                  <td>
                    ...
                    <div style="font-size:12px;color:var(--text-light);">{{ $cooperador->website }}</div>
                  </td>
                  <td>
                    <span
                  ...
                  <td style="text-align:center;">
                    <div style="display:flex;gap:6px;justify-content:center;">
                      ...
                      data-id="{{ $cooperador->id }}"
                      data-nome="{{ $cooperador->nome}}" 
                      data-nif="{{ $cooperador->nif ?? '' }}"
                      data-telefone="{{ $cooperador->telefone?? '' }}"
                      data-email="{{ $cooperador->email ?? '' }}" 
                      data-endereco="{{ $cooperador->endereco ?? '' }}"
                      data-estado="{{ $cooperador->estado ?? 'activo' }}" 
                      data-foto="{{ $cooperador->foto }}">
